...
var sitPlayerOnTable = function(params, cb) {
 ...
 //  });
  ...
  params.self.app.rpc.database.ofcRequestRemote.processOFCautoSit(params.session, {channelId: params.channelId, playerId: params.playerId, seatIndex: params.seatIndex, playerName: params.playerName , imageAvtar: params.imageAvtar, networkIp: params.networkIp, isRequested: params.isRequested}, function (processOFCautoSitResponse) {
