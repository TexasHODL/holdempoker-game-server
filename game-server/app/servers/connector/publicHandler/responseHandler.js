...
createHandlerResponse.setJoinChannelKeys = function(params, cb) {
  ...
  serverLog(stateOfX.serverLogType.info, 'Additional turn time: ' + res.tableDetails.additionalTurnTime + ' and remaining move time: ' + res.tableDetails.remainingMoveTime);
  ...
  async.each(params.table.players, function(player, ecb) {
    res.tableDetails.players.push({
      ...
      totalGameBet        : player.totalGameBet,
