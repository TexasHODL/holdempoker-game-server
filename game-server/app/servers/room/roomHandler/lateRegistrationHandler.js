...
var registerTournament = function(params, cb) {
  ...
  pomelo.app.rpc.database.tournament.registerTournament(params.session, {playerId: params.playerId, tournamentId: params.tournamentId, isEligibleForRebuy: params.isEligibleForRebuy}, function(registerTournamentResponse) {
  ...
  async.waterfall([
    ...
    if(err) {
      ...
      if(params.isRegistrationSuccess) {
        ...
        pomelo.app.rpc.database.tournament.deRegisterTournament(params.session, {playerId: params.playerId, tournamentId: params.tournamentId, gameVersionCount: params.gameVersionCount}, function(registerTournamentResponse) {
