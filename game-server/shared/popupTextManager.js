...
popupTextManager.falseMessages = {
    ...
    "TABLEBUYRESPONSEFAIL_SITHEREHANDLER"                                          : "The chips amount are invalid. Please try with different amount",
    ...
    // "GETCONNECTOR_INVALIDPASSWORD_GATEHANDLER"                                     : "Password should contain at least one capital letter and one number",
    ...
    "REGISTERTOURNAMENTFAIL_TOURNAMENT"                                            : "Sorry, we are unable to download tournamnet data. Please try again",
    ...
    "ADDCHIPSONTABLE_ADDAMOUNTFAIL_TABLEMANAGER"                                   : "Please provide a valid value to add chips",
    "ADDCHIPSONTABLE_PLAYERTOOKASEAT_TABLEMANAGER"                                 : "Invalid attempt to add chips, Please take a seat first!",
    "ADDCHIPSONTABLE_TOTALEXCEEDTABLEMAXBUY_TABLEMANAGER"                          : "Please provide a valid value to add chips. It cannot be more than the max buyin for the table ",
    "ADDCHIPSONTABLE_FOLDEDPLAYERFAIL_TABLEMANAGER"                                : "Sorry, you can add chips only when the round is over",
    "ADDCHIPSONTABLEOUTOFMONEYFAIL_TABLEMANAGER"                                   : "Please provide a valid value to add chips",
    "ADDCHIPSONTABLEINTOURNAMENT_TABLEMANAGER"                                     : "Invalid attempt to add chips, Please take a seat first!",
    ...
    "USERRESPONSE_FREECHIPS_AVAILABLE_USER"                        : "Maximum free chips allowed are availed.",
    "USERRESPONSE_FREECHIPS_NOTAVAILABLE_USER"                     : "You've already claimed your play money chips for today.Come back tomorrow to get more!",
    ...
    "GETTOURNAMENTROOM_DYNAMICRANKS"                                                  : "Sorry, we are unable to download tournamnet data. Please register in another tournament. ",
    ...
    "PROFILEMGMTADDCHIPS_REFUNDAMOUNTONLEAVE_LEAVEREMOTE"                             : "Refund money to player account failed on - ",
    ...
    "SUCCESS_SENT_EMAILVERFICATIONLINK" : "EmailVerificationLink  sent to email successfully",
...
popupTextManager.dbQyeryInfo = {
    ...
    "DB_SENDOTPMESSAGE_SUCCESS_USER1"                                            : "Dear User, OTP for your mobile verification on pokermoogley.com is ",
    ...
    "DBADDREALCHIPSTOMULTIPLEPLAYERSFAIL_CANCELTOURNAMENT"                       : "Sorry, something went wrong while adding chips. Please try again",
    "DBADDFREECHIPSTOMULTIPLEPLAYERSFAIL_CANCELTOURNAMENT"                       : "Sorry, something went wrong while adding chips. Please try again",
    ...
    "DBGETCUSTOMER_CHECKUSERBALANCENOREALMONEY_TOURNAMENTREGISTRATION"           : "Insufficient real money chips are there in your account to join",
    "DBGETCUSTOMER_CHECKUSERBALANCENOSUFFICIENTPLAYCHIPS_TOURNAMENTREGISTRATION" : "Insufficient play money chips are there in your account to join",
    ...
    "DBGETCUSTOMERUSER_JOINPLAYERINQUEUE_INSUFFICIENTAMOUNT_TABLEMANAGER"        : "You have insufficient chips in your account. Please update your chips balance.",
    ...
    "DB_UPDATEUSERCHIPS_SUCCESS_USER"                                : "Chips has been successfully added to your account",
...
module.exports = popupTextManager;
