...
"use strict";
  ...
  var broadcastHandler 	= require("../../publicHandler/broadcastHandler"),
...
ofcActionLogger.createEventLog = function (params) {
  ...
  if(!!params.data && !!params.data.channelId) {
    ...
    params.self.app.rpc.database.ofcRequestRemote.createLog(params.session, {channelId:  params.data.channelId, data: params.data}, function (createLogResponse) {
