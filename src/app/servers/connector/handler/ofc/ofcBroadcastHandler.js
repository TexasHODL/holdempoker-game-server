...
ofcBroadcastHandler.sendMessageToUser = function (params) {
   keyValidator.validateKeySets('Request', 'connector', "sendMessageToUser", params, function (validated){
    if(validated.success) {
      params.self.app.rpcInvoke(params.self.app.get('serverId'), {namespace: "user", service: "entryRemote", method: "sendMessageToUser", args: [params.playerId, params.msg, params.route]}, function(data){
