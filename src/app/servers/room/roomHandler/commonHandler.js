...
commonHandler.broadcastChips = function(params) {
  db.getCustomUser(params.playerId, {freeChips: 1, realChips:1}, function(err, user) {
    broadcastHandler.sendMessageToUser({ serverId: params.serverId, msg: {playerId: params.playerId, updated: {freeChips: user.freeChips, realChips: user.realChips+user.instantBonusAmount, instantBonusAmount: user.instantBonusAmount}}, playerId: params.playerId, route: stateOfX.broadcasts.updateProfile});
  });
};
