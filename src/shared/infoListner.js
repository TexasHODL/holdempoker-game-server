...
subscriber.on("message", function (data) {
  ...
  switch (msg.logType) {
    case stateOfX.serverLogType.info:
      logText =
        chalk.green(
          "\n[" +
            msg.timestamp +
            "] " +
            msg.serverName.toUpperCase() +
            " - [" +
            msg.logType +
            "] - "
        ) +
      ...
      console.log(logText);
      break;
    case stateOfX.serverLogType.warning:
      logText =
        chalk.yellow(
          "\n[" +
            msg.timestamp +
      ...
      console.log(logText);
      break;
    case stateOfX.serverLogType.error:
      logText =
        chalk.red(
          "\n[" +
            msg.timestamp +
      ...
      console.log(logText);
      break;
    case stateOfX.serverLogType.request:
      logText =
        chalk.cyan(
          "\n[" +
            msg.timestamp +
      ...
      console.log(logText);
      break;
    case stateOfX.serverLogType.response:
      logText =
        chalk.cyan(
          "\n[" +
            msg.timestamp +
      ...
      console.log(logText);
      break;
    case stateOfX.serverLogType.broadcast:
      logText =
        chalk.yellow(
          "\n[" +
            msg.timestamp +
      ...
      console.log(logText);
      break;
    case stateOfX.serverLogType.dbQuery:
      logText =
        chalk.magenta(
          "\n[" +
            msg.timestamp +
...
subscriber.connect(
  "tcp://" + detailIp.connServerIp + ":" + detailIp.connServerPort
);
subscriber.connect(
  "tcp://" + detailIp.databaseServerIp + ":" + detailIp.databaseServerPort
);
subscriber.connect(
  "tcp://" + detailIp.roomServerIp + ":" + detailIp.roomServerlogPort
);
